/*-------------------------------------------------------------------------*
 |                                                                         
 |            STATA SUPPLEMENTAL SYNTAX FILE FOR ICPSR 37021
...
replace ADMTYPE = . if (ADMTYPE == 9)
replace OFFGENERAL = . if (OFFGENERAL == 9)
replace SENTLGTH = . if (SENTLGTH == 9)
replace OFFDETAIL = . if (OFFDETAIL == 99)
replace RACE = . if (RACE == 9)
replace AGEADMIT = . if (AGEADMIT == 9)
